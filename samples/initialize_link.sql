...
values('account', 1, 100000, 1, 'blockchain account table');
...
values('account','account','account',current_timestamp,current_timestamp);
...
values('account','corp_2_store', 100, current_timestamp, current_timestamp);
